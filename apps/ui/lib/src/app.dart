...
/// Как часто экраны сами перечитывают данные.
///
/// Сервер ничего в браузер не шлёт, а состояние меняется без участия
/// смотрящего: проверка сайта по расписанию, авто-публикация, действия
/// другого ответственного.
const autoRefreshInterval = Duration(seconds: 30);
